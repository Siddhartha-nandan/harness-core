...
public class NGTriggerRepositoryCustomImplTest extends CategoryTest {
  ...
  @Category(UnitTests.class)
  public void testEnableAllTriggersInBulkForAnAccount() {
    String ACCOUNT_ID = "accountId";

    BulkTriggersRequestDTO bulkTriggersRequestDTO = BulkTriggersRequestDTO.builder()
                                                        .filters(BulkTriggersFilterRequestDTO.builder().build())
    ...
    when(mongoTemplate.bulkOps(BulkOperations.BulkMode.UNORDERED, NGTriggerEntity.class)).thenReturn(bulkOperations);
    when(bulkOperations.updateMulti(query, update)).thenReturn(bulkOperations);
    when(bulkOperations.execute()).thenReturn(bulkWriteResult);
  ...
  @Owner(developers = VED)
  @Category(UnitTests.class)
  public void testDisableAllTriggersInBulkForAnOrg() {
    String ACCOUNT_ID = "accountId";
    String ORG_ID = "orgId";

    BulkTriggersRequestDTO bulkTriggersRequestDTO =
        BulkTriggersRequestDTO.builder()
            .filters(BulkTriggersFilterRequestDTO.builder().orgIdentifier(ORG_ID).build())
            .data(BulkTriggersDataRequestDTO.builder().enable(false).build())
            .build();
  ...
  @Owner(developers = VED)
  @Category(UnitTests.class)
  public void testDisableAllTriggersInBulkForAProject() {
    String ACCOUNT_ID = "accountId";
    String ORG_ID = "orgId";
    ...
    BulkTriggersRequestDTO bulkTriggersRequestDTO =
        BulkTriggersRequestDTO.builder()
            .filters(BulkTriggersFilterRequestDTO.builder().orgIdentifier(ORG_ID).projectIdentifier(PROJECT_ID).build())
            .data(BulkTriggersDataRequestDTO.builder().enable(false).build())
            .build();
  ...
  @Owner(developers = VED)
  @Category(UnitTests.class)
  public void testDisableAllTriggersInBulkForAPipeline() {
    String ACCOUNT_ID = "accountId";
    String ORG_ID = "orgId";
    String PROJECT_ID = "projectId";
  ...
  @Owner(developers = VED)
  @Category(UnitTests.class)
  public void testEnableAllTriggersInBulkForATriggerTypeInAnAccount() {
    String ACCOUNT_ID = "accountId";

    BulkTriggersRequestDTO bulkTriggersRequestDTO =
        BulkTriggersRequestDTO.builder()
            .filters(BulkTriggersFilterRequestDTO.builder().type("ARTIFACT").build())
            .data(BulkTriggersDataRequestDTO.builder().enable(true).build())
            .build();
