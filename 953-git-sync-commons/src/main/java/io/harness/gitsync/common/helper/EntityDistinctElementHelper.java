...
public class EntityDistinctElementHelper {
  public <T> Page<T> getDistinctElementPage(
    ...
    return getDistinctElementPage(mongoTemplate, criteria, pageable, entityClass, false, distinctKey);
  }

  public <T> Page<T> getDistinctElementPage(MongoTemplate mongoTemplate, Criteria criteria, Pageable pageable,
      Class<T> entityClass, boolean useCollation, String... distinctKeys) {
    ...
    if (useCollation) {
      ...
      aggregationForEntity.withOptions(aggregationOptions);
    }
