...
replace_key_value resourceGroupServiceConfig.redisLockConfig.sslConfig.enabled $LOCK_CONFIG_REDIS_SSL_ENABLED
replace_key_value resourceGroupServiceConfig.redisLockConfig.sslConfig.CATrustStorePath $LOCK_CONFIG_REDIS_SSL_CA_TRUST_STORE_PATH
replace_key_value resourceGroupServiceConfig.redisLockConfig.sslConfig.CATrustStorePassword $LOCK_CONFIG_REDIS_SSL_CA_TRUST_STORE_PASSWORD
