...
if [[ ( -z "$DISABLE_CLIENT_TOOLS") || ("$DISABLE_CLIENT_TOOLS" = "false") ]]; then
  ...
  && mkdir -m 777 -p client-tools/scm/6c979d31 \
  && curl -s -L -o client-tools/scm/6c979d31/scm https://app.harness.io/public/shared/tools/scm/release/6c979d31/bin/linux/$ARCH/scm
else
