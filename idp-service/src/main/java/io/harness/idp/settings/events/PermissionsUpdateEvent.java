...
@Getter
@NoArgsConstructor
public class PermissionsUpdateEvent implements Event {
  public static final String PERMISSIONS_UPDATED = "PermissionsUpdated";

  private BackstagePermissions newBackstagePermissions;
  private BackstagePermissions oldBackstagePermissions;
  private String accountIdentifier;

  public PermissionsUpdateEvent(String accountIdentifier, BackstagePermissions newBackstagePermissions,
      BackstagePermissions oldBackstagePermissions) {
    this.newBackstagePermissions = newBackstagePermissions;
    this.oldBackstagePermissions = oldBackstagePermissions;
