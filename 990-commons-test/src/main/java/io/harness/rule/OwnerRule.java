...
public class OwnerRule implements TestRule {
  ...
  public static final String AKSHAY = "akshay.khole";
  ...
  public static final String ANSHIKA = "anshika.anand";
  ...
  public static final String ASHINSABU = "ashin.sabu";
  ...
  public static final String MANISH = "manish.singh";
  ...
  public static final String SUJEESH = "sujeesh.madathil";
  ...
  public static final String SANDESH_SALUNKHE = "sandesh.salunkhe";
  ...
  public static final String APOORV_ARORA = "apoorv.arora";
  public static final String ASHUTOSH_TRIPATHI = "ashutosh.tripathi";
  ...
  public static final String SHUBHENDU = "shubhendu.patidar";
  public static final String EOIN_MCAFEE = "eoin.mcafee";

  public static final String DMACK = "daniel.mack";
  public static final String BHAVI = "bhavi.khator";
  ...
  private static final Map<String, UserInfo> active =
      ImmutableMap.<String, UserInfo>builder()
          ...
          .put(SHUBHENDU, defaultUserInfo(SHUBHENDU).slack("U05R38YQ8J3").team(CV).build())
          ...
          .put(AKSHAY, defaultUserInfo(AKSHAY).slack("U042Y23SDL7").team(PL).build())
          ...
          .put(ASHINSABU, defaultUserInfo(ASHINSABU).slack("U05GVL72Z19").team(SPG).build())
          ...
          .put(MANISH, defaultUserInfo(MANISH).slack("U05P47FTAM6").team(CDP).build())
          ...
          .put(SUJEESH, defaultUserInfo(SUJEESH).slack("U030GNDDENL").team(CE).build())
          ...
          .put(SANDESH_SALUNKHE, defaultUserInfo(SANDESH_SALUNKHE).slack("U05FC66AV6W").team(CDC).build())
          ...
          .put(VIKYATH_HAREKAL, defaultUserInfo(VIKYATH_HAREKAL).slack("U03JNRMSLSK").team(IDP).build())
          ...
          .put(APOORV_ARORA, defaultUserInfo(APOORV_ARORA).slack("U05K2ABPPPS").team(CDC).build())
