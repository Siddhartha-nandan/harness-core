...
public class UserSettingUpdateResponseDTO {

    @Schema(description = IDENTIFIER)
    @NotBlank String identifier;
    @NotNull UserSettingDTO userSettingDTO;
    @Schema(description = LAST_MODIFIED_AT)
    Long lastModifiedAt;
    @Schema(description = BATCH_ITEM_RESPONSE_STATUS)
    boolean updateStatus;
    @Schema(description = BATCH_ITEM_ERROR_MESSAGE)
    String errorMessage;
