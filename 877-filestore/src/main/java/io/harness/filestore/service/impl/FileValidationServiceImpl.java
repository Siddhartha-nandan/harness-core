...
public class FileValidationServiceImpl implements FileValidationService {
  ...
  private void validateExistenceOfAccountOrOrgOrProject(@NotNull FileDTO fileDto) {
    ...
    if (isNotEmpty(projectIdentifier)) {
      ...
      organizationService.get(ScopeInfo.builder().accountIdentifier(accountIdentifier).scopeType(ScopeLevel.ACCOUNT).uniqueId(accountIdentifier).build(), orgIdentifier)
          .orElseThrow(()
