...
public class GovernanceRuleEnforcementResource {
  ...
  create(@Parameter(required = true, description = NGCommonEntityConstants.ACCOUNT_PARAM_MESSAGE) @QueryParam(
    ...
    try {
      CronExpression cronSequenceGenerator = CronExpression.parse(ruleEnforcement.getExecutionSchedule());
      CronExpression.isValidExpression(String.valueOf(cronSequenceGenerator));
