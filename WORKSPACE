...
go_repository(
    ...
    sum = "h1:yC8/w9w2jbNFhLk331hcp+T5xdtoyjPWlOPJWVWD0Fg=",
    version = "v1.34.3",
)
...
go_repository(
    name = "com_github_harness_harness_core",
    importpath = "github.com/harness/harness-core",
    sum = "h1:E8suiqYe5H1qiZu+UgaXf8nERxaAXAXVjefocC4h8Ok=",
    version = "v0.0.0-20230630234258-c5cacffec07e",
)

go_repository(
    name = "com_github_harness_harness_core_commons_go_lib",
    importpath = "github.com/harness/harness-core/commons/go/lib",
    sum = "h1:hLZq2pto6TfK60nXWsuAOz9eUOnbVu8yB1iXbe1UQW8=",
    version = "v0.0.0-20230704115211-8b21b2758330",
)
...
plain_artifacts = [
    ...
    "com.azure:azure-core-management:1.11.1",
    "com.azure.resourcemanager:azure-resourcemanager:2.26.0",
    "com.azure.resourcemanager:azure-resourcemanager-appservice:2.26.1",
    "com.azure.resourcemanager:azure-resourcemanager-authorization:2.26.0",
    "com.azure.resourcemanager:azure-resourcemanager-compute:2.26.0",
    "com.azure.resourcemanager:azure-resourcemanager-containerinstance:2.26.0",
    "com.azure.resourcemanager:azure-resourcemanager-containerregistry:2.26.0",
    "com.azure.resourcemanager:azure-resourcemanager-containerservice:2.26.0",
    "com.azure.resourcemanager:azure-resourcemanager-keyvault:2.26.0",
    "com.azure.resourcemanager:azure-resourcemanager-msi:2.26.0",
    "com.azure.resourcemanager:azure-resourcemanager-monitor:2.26.0",
    "com.azure.resourcemanager:azure-resourcemanager-network:2.26.0",
    "com.azure.resourcemanager:azure-resourcemanager-resources:2.26.0",
    "com.azure.resourcemanager:azure-resourcemanager-storage:2.26.0",
    ...
    "io.fabric8:openshift-client:6.5.1",
    "io.fabric8:kubernetes-client-project:6.5.1",
    "io.fabric8:openshift-client:6.5.1",
    "io.fabric8:kubernetes-model-generator:6.5.1",
    "io.fabric8:openshift-model:6.5.1",
    "io.fabric8:istio-client:6.5.1",
    "io.fabric8:kubernetes-extensions:6.5.1",
    "io.fabric8:istio-model-v1beta1:6.5.1",
    "io.fabric8:istio-model-v1alpha3:6.5.1",
    ...
    "io.grpc:grpc-alts:1.58.1",
    "io.grpc:grpc-api:1.58.1",
    "io.grpc:grpc-auth:1.58.1",
    "io.grpc:grpc-context:1.58.1",
    "io.grpc:grpc-core:1.58.1",
    "io.grpc:grpc-grpclb:1.58.1",
    "io.grpc:grpc-netty-shaded:1.58.1",
    "io.grpc:grpc-netty:1.58.1",
    "io.grpc:grpc-protobuf-lite:1.58.1",
    "io.grpc:grpc-protobuf:1.58.1",
    "io.grpc:grpc-services:1.58.1",
    "io.grpc:grpc-stub:1.58.1",
    ...
    "io.netty:netty-transport-native-epoll:linux-x86_64:4.1.101.Final",
    ...
    "io.projectreactor.netty:reactor-netty:1.1.14",
    ...
    "org.eclipse.jetty:jetty-alpn-openjdk8-server:9.4.53.v20231009",
...
maven_install(
    ...
    artifacts = plain_artifacts + amazon_artifacts + amazon_v2_artifacts + powermock_artifacts + [
        ...
        maven_test_artifact("de.bwaldvogel:mongo-java-server-core:1.43.0"),
        maven_test_artifact("de.bwaldvogel:mongo-java-server-memory-backend:1.43.0"),
        maven_test_artifact("de.bwaldvogel:mongo-java-server:1.43.0"),
        maven_test_artifact("io.dropwizard:dropwizard-testing:2.0.10"),
        maven_test_artifact("io.fabric8:kubernetes-server-mock:6.5.1"),
        maven_test_artifact("org.junit.jupiter:junit-jupiter-api:5.8.2"),
        maven_test_artifact("io.fabric8:mockwebserver:0.2.2"),
        maven_test_artifact("io.grpc:grpc-testing:1.58.1"),
