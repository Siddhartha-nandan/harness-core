...
A Helm chart for Kubernetes System
...
| featureFlags.STO | string | `"STO_STEP_PALETTE_BURP_ENTERPRISE,STO_STEP_PALETTE_CODEQL,STO_STEP_PALETTE_FOSSA,STO_STEP_PALETTE_GIT_LEAKS,STO_STEP_PALETTE_SEMGREP,STO_STEP_PALETTE_SYSDIG,STO_STEP_PALETTE_ANCHORE_ENTERPRISE"` | STO Feature Flags |
