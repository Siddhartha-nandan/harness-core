...
public interface GitFileLocationRepository
  ...
  Optional<GitFileLocation> findByAccountIdAndOrganizationIdAndProjectIdAndCompleteGitPathAndRepoAndBranch(
      String accountIdentifier, String organizationId, String projectId, String completeFilePath, String repoUrl,
      String branch);
}
