...
public enum ModuleType {
  ...
  @JsonProperty("CODE") CODE("Code", PUBLIC, ONBOARDED), // TODO: Remove internal flag once licensing is added.
  ...
  @JsonProperty("SSCA") SSCA("Ssca", INTERNAL, ONBOARDING_IN_PROGRESS),
