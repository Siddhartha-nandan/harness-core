...
public class InstanceSyncStepResolver {
  public final Set<String> INSTANCE_SYN_STEP_TYPES = Collections.unmodifiableSet(
      Sets.newHashSet(K8sRollingStep.STEP_TYPE.getType(), K8sRollingStepV2.STEP_TYPE.getType(),
          K8sCanaryStep.STEP_TYPE.getType(), K8sCanaryStepV2.STEP_TYPE.getType(), K8sBlueGreenStep.STEP_TYPE.getType(),
          K8sBlueGreenStepV2.STEP_TYPE.getType(), K8sRollingRollbackStep.STEP_TYPE.getType(),
          HelmDeployStep.STEP_TYPE.getType(), HelmDeployStepV2.STEP_TYPE.getType(),
          HelmRollbackStep.STEP_TYPE.getType(), HelmRollbackStepV2.STEP_TYPE.getType(),
          ...
          EcsRollingDeployStep.STEP_TYPE.getType(), EcsRollingDeployStepV2.STEP_TYPE.getType(),
          EcsRollingRollbackStep.STEP_TYPE.getType(), EcsRollingRollbackStepV2.STEP_TYPE.getType(),
          EcsCanaryDeployStep.STEP_TYPE.getType(), EcsCanaryDeployStepV2.STEP_TYPE.getType(),
          EcsBlueGreenSwapTargetGroupsStep.STEP_TYPE.getType(), EcsBlueGreenSwapTargetGroupsStepV2.STEP_TYPE.getType(),
          EcsBlueGreenRollbackStep.STEP_TYPE.getType(), EcsBlueGreenRollbackStepV2.STEP_TYPE.getType(),
          FetchInstanceScriptStep.STEP_TYPE.getType(), ElastigroupDeployStep.STEP_TYPE.getType(),
          TasAppResizeStep.STEP_TYPE.getType(), TasAppResizeStepV2.STEP_TYPE.getType(),
          TasSwapRoutesStep.STEP_TYPE.getType(), TasSwapRoutesStepV2.STEP_TYPE.getType(),
          TasRollbackStep.STEP_TYPE.getType(), TasRollbackStepV2.STEP_TYPE.getType(),
          TasSwapRollbackStep.STEP_TYPE.getType(), TasSwapRollbackStepV2.STEP_TYPE.getType(),
          ElastigroupBGStageSetupStep.STEP_TYPE.getType(), ElastigroupSwapRouteStep.STEP_TYPE.getType(),
          ElastigroupRollbackStep.STEP_TYPE.getType(), TasRollingDeployStep.STEP_TYPE.getType(),
          TasRollingRollbackStep.STEP_TYPE.getType(), TasRollingRollbackStepV2.STEP_TYPE.getType(),
