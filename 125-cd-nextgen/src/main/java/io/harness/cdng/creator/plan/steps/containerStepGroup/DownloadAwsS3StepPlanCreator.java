...
public class DownloadAwsS3StepPlanCreator extends CDPMSStepPlanCreatorV2<DownloadAwsS3StepNode> {
  @Override
  public Set<String> getSupportedStepTypes() {
    return Sets.newHashSet(StepSpecTypeConstants.DOWNLOAD_AWS_S3);
  }

  @Override
  public Class<DownloadAwsS3StepNode> getFieldClass() {
    return DownloadAwsS3StepNode.class;
  }

  @Override
  public PlanCreationResponse createPlanForField(PlanCreationContext ctx, DownloadAwsS3StepNode stepNode) {
