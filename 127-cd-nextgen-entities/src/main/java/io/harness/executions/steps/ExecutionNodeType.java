...
public enum ExecutionNodeType {
  ...
  DEPLOYMENT_STAGE_STEP_V1("DEPLOYMENT_STAGE_STEP_V1", YamlTypesV1.DEPLOYMENT_STAGE),
  ...
  K8S_APPLY_V2("K8S_APPLY_V2", YamlTypes.K8S_APPLY),
  ...
  K8S_DELETE_V2("K8S_DELETE_V2", YamlTypes.K8S_DELETE),
  ...
  K8S_DRY_RUN_MANIFEST_V2("K8S_DRY_RUN_V2", YamlTypes.K8S_DRY_RUN_MANIFEST),
  ...
  HELM_DEPLOY_V2("HELM_DEPLOY_V2", YamlTypes.HELM_DEPLOY),
  HELM_ROLLBACK("HELM_ROLLBACK", YamlTypes.HELM_ROLLBACK),
  HELM_ROLLBACK_V2("HELM_ROLLBACK_V2", YamlTypes.HELM_ROLLBACK),
  ...
  ECS_ROLLING_DEPLOY_V2("ECS_ROLLING_DEPLOY_V2", YamlTypes.ECS_ROLLING_DEPLOY),
  ECS_ROLLING_ROLLBACK("ECS_ROLLING_ROLLBACK", YamlTypes.ECS_ROLLING_ROLLBACK),
  ECS_ROLLING_ROLLBACK_V2("ECS_ROLLING_ROLLBACK_V2", YamlTypes.ECS_ROLLING_ROLLBACK),
  ECS_CANARY_DEPLOY("ECS_CANARY_DEPLOY", YamlTypes.ECS_CANARY_DEPLOY),
  ECS_CANARY_DEPLOY_V2("ECS_CANARY_DEPLOY_V2", YamlTypes.ECS_CANARY_DEPLOY),
  ECS_CANARY_DELETE("ECS_CANARY_DELETE", YamlTypes.ECS_CANARY_DELETE),
  ECS_CANARY_DELETE_V2("ECS_CANARY_DELETE_V2", YamlTypes.ECS_CANARY_DELETE),
  ...
  ECS_BLUE_GREEN_CREATE_SERVICE_V2("ECS_BLUE_GREEN_CREATE_SERVICE_V2", YamlTypes.ECS_BLUE_GREEN_CREATE_SERVICE),
  ECS_BLUE_GREEN_SWAP_TARGET_GROUPS("ECS_BLUE_GREEN_SWAP_TARGET_GROUPS", YamlTypes.ECS_BLUE_GREEN_SWAP_TARGET_GROUPS),
  ECS_BLUE_GREEN_SWAP_TARGET_GROUPS_V2(
      "ECS_BLUE_GREEN_SWAP_TARGET_GROUPS_V2", YamlTypes.ECS_BLUE_GREEN_SWAP_TARGET_GROUPS),
  ECS_BLUE_GREEN_ROLLBACK("ECS_BLUE_GREEN_ROLLBACK", YamlTypes.ECS_BLUE_GREEN_ROLLBACK),
  ECS_BLUE_GREEN_ROLLBACK_V2("ECS_BLUE_GREEN_ROLLBACK_V2", YamlTypes.ECS_BLUE_GREEN_ROLLBACK),
  ...
  ECS_RUN_TASK_V2("ECS_RUN_TASK_V2", StepSpecTypeConstants.ECS_RUN_TASK),
  ...
  TAS_CANARY_APP_SETUP_V2("TAS_CANARY_APP_SETUP_V2", YamlTypes.TAS_CANARY_APP_SETUP),
  TAS_BG_APP_SETUP("TAS_BG_APP_SETUP", YamlTypes.TAS_BG_APP_SETUP),
  TAS_BG_APP_SETUP_V2("TAS_BG_APP_SETUP_V2", YamlTypes.TAS_BG_APP_SETUP),
  TAS_BASIC_APP_SETUP("TAS_BASIC_APP_SETUP", YamlTypes.TAS_BASIC_APP_SETUP),
  TAS_BASIC_APP_SETUP_V2("TAS_BASIC_APP_SETUP_V2", YamlTypes.TAS_BASIC_APP_SETUP),
  TAS_APP_RESIZE("TAS_APP_RESIZE", YamlTypes.TAS_APP_RESIZE),
  TAS_APP_RESIZE_V2("TAS_APP_RESIZE_V2", YamlTypes.TAS_APP_RESIZE),
  TAS_SWAP_ROUTES("TAS_SWAP_ROUTES", YamlTypes.TAS_SWAP_ROUTES),
  TAS_SWAP_ROUTES_V2("TAS_SWAP_ROUTES_V2", YamlTypes.TAS_SWAP_ROUTES),
  TAS_ROLLBACK("TAS_ROLLBACK", YamlTypes.TAS_ROLLBACK),
  TAS_ROLLBACK_V2("TAS_ROLLBACK_V2", YamlTypes.TAS_ROLLBACK),
  SWAP_ROLLBACK("SWAP_ROLLBACK", YamlTypes.SWAP_ROLLBACK),
  SWAP_ROLLBACK_V2("SWAP_ROLLBACK_V2", YamlTypes.SWAP_ROLLBACK),
  TANZU_COMMAND("TANZU_COMMAND", YamlTypes.TANZU_COMMAND),
  TANZU_COMMAND_V2("TANZU_COMMAND_V2", YamlTypes.TANZU_COMMAND),
  ...
  TAS_ROLLING_DEPLOY_V2("TAS_ROLLING_DEPLOY_V2", YamlTypes.TAS_ROLLING_DEPLOY),
  TAS_ROLLING_ROLLBACK("TAS_ROLLING_ROLLBACK", YamlTypes.TAS_ROLLING_ROLLBACK),
  TAS_ROLLING_ROLLBACK_V2("TAS_ROLLING_ROLLBACK_V2", YamlTypes.TAS_ROLLING_ROLLBACK),
  ...
  TAS_ROUTE_MAPPING_V2("ROUTE_MAPPING_V2", YamlTypes.TAS_ROUTE_MAPPING),
  ...
  ECS_SERVICE_SETUP_V2("ECS_SERVICE_SETUP_V2", YamlTypes.ECS_SERVICE_SETUP),
  ECS_UPGRADE_CONTAINER("ECS_UPGRADE_CONTAINER", YamlTypes.ECS_UPGRADE_CONTAINER),
  ECS_UPGRADE_CONTAINER_V2("ECS_UPGRADE_CONTAINER_V2", YamlTypes.ECS_UPGRADE_CONTAINER),
  ECS_BASIC_ROLLBACK("ECS_BASIC_ROLLBACK", YamlTypes.ECS_BASIC_ROLLBACK),
  ECS_BASIC_ROLLBACK_V2("ECS_BASIC_ROLLBACK_V2", YamlTypes.ECS_BASIC_ROLLBACK),
  ...
  DOWNLOAD_HARNESS_STORE("DOWNLOAD_HARNESS_STORE", YamlTypes.DOWNLOAD_HARNESS_STORE);
