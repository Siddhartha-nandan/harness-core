...
package io.harness.oidc.delegate;
...
public class GcpOidcTokenExchangeDetailsForDelegate {
  ...
  public GcpOidcServiceAccountAccessTokenResponse exchangeOidcServiceAccountAccessToken() {
    ...
    try {
      ...
      return GcpOidcServiceAccountAccessTokenResponse.builder()
          .accessToken(generateAccessTokenResponse.getAccessToken())
          .expireTime(generateAccessTokenResponse.getExpireTime().getSeconds())
          .build();
